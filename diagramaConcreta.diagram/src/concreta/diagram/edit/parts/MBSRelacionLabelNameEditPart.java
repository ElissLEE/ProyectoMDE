...
public class MBSRelacionLabelNameEditPart extends LabelEditPart implements ITextAwareEditPart {
	...
	*/
	static {
		registerSnapBackPosition(
				ConcretaVisualIDRegistry.getType(concreta.diagram.edit.parts.MBSRelacionLabelNameEditPart.VISUAL_ID),
				new Point(0, 40));
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = ConcretaParserProvider.getParser(ConcretaElementTypes.MBSRelacion_4001, getParserElement(),
					ConcretaVisualIDRegistry
							.getType(concreta.diagram.edit.parts.MBSRelacionLabelNameEditPart.VISUAL_ID));
		}
		return parser;
	}
