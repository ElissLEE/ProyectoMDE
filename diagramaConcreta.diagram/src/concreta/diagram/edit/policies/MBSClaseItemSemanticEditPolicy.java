 ...
 * @generated
 */
public class MBSClaseItemSemanticEditPolicy extends ConcretaBaseItemSemanticEditPolicy {

	/**
	* @generated
	*/
	public MBSClaseItemSemanticEditPolicy() {
	...
	*/
	protected Command getDestroyElementCommand(DestroyElementRequest req) {
		...
		for (Iterator<?> it = view.getTargetEdges().iterator(); it.hasNext();) {
			...
			if (ConcretaVisualIDRegistry.getVisualID(incomingLink) == MBSRelacionEditPart.VISUAL_ID) {
