	...
	*/
	public Object[] getChildren(Object parentElement) {
		if (parentElement instanceof IFile) {
			...
			result.addAll(
					createNavigatorItems(selectViewsByType(topViews, MBSDiagramaClasesEditPart.MODEL_ID), file, false));
	...
	private Object[] getViewChildren(View view, Object parentElement) {
		...
		case MBSDiagramaClasesEditPart.VISUAL_ID: {
			...
			ConcretaNavigatorGroup links = new ConcretaNavigatorGroup(
					Messages.NavigatorGroupName_MBSDiagramaClases_1000_links, "icons/linksNavigatorGroup.gif", //$NON-NLS-1$
					parentElement);
			Collection<View> connectedViews;
			connectedViews = getChildrenByType(Collections.singleton(sv),
					ConcretaVisualIDRegistry.getType(MBSClaseEditPart.VISUAL_ID));
			result.addAll(createNavigatorItems(connectedViews, parentElement, false));
			connectedViews = getChildrenByType(Collections.singleton(sv),
					ConcretaVisualIDRegistry.getType(MBSPaqueteEditPart.VISUAL_ID));
			result.addAll(createNavigatorItems(connectedViews, parentElement, false));
			connectedViews = getDiagramLinksByType(Collections.singleton(sv),
					ConcretaVisualIDRegistry.getType(MBSRelacionEditPart.VISUAL_ID));
			links.addChildren(createNavigatorItems(connectedViews, links, false));
			connectedViews = getDiagramLinksByType(Collections.singleton(sv),
					ConcretaVisualIDRegistry.getType(MBSHerenciaEditPart.VISUAL_ID));
			links.addChildren(createNavigatorItems(connectedViews, links, false));
			connectedViews = getDiagramLinksByType(Collections.singleton(sv),
					ConcretaVisualIDRegistry.getType(MBSContainmentEditPart.VISUAL_ID));
			links.addChildren(createNavigatorItems(connectedViews, links, false));
			if (!links.isEmpty()) {
				result.add(links);
			}
		...
		case MBSClaseEditPart.VISUAL_ID: {
			...
			ConcretaNavigatorGroup incominglinks = new ConcretaNavigatorGroup(
					Messages.NavigatorGroupName_MBSClase_2001_incominglinks, "icons/incomingLinksNavigatorGroup.gif", //$NON-NLS-1$
					parentElement);
			ConcretaNavigatorGroup outgoinglinks = new ConcretaNavigatorGroup(
					Messages.NavigatorGroupName_MBSClase_2001_outgoinglinks, "icons/outgoingLinksNavigatorGroup.gif", //$NON-NLS-1$
					parentElement);
			Collection<View> connectedViews;
			connectedViews = getChildrenByType(Collections.singleton(sv),
					ConcretaVisualIDRegistry.getType(MBSClaseMBSClaseAtributosCompartmentEditPart.VISUAL_ID));
			connectedViews = getChildrenByType(connectedViews,
					ConcretaVisualIDRegistry.getType(MBSAtributoEditPart.VISUAL_ID));
			result.addAll(createNavigatorItems(connectedViews, parentElement, false));
			connectedViews = getChildrenByType(Collections.singleton(sv),
					ConcretaVisualIDRegistry.getType(MBSClaseMBSClaseMetodosCompartmentEditPart.VISUAL_ID));
			connectedViews = getChildrenByType(connectedViews,
					ConcretaVisualIDRegistry.getType(MBSMetodoEditPart.VISUAL_ID));
			result.addAll(createNavigatorItems(connectedViews, parentElement, false));
		...
		case MBSRelacionEditPart.VISUAL_ID: {
			...
			ConcretaNavigatorGroup target = new ConcretaNavigatorGroup(
					Messages.NavigatorGroupName_MBSRelacion_4001_target, "icons/linkTargetNavigatorGroup.gif", //$NON-NLS-1$
					parentElement);
			ConcretaNavigatorGroup source = new ConcretaNavigatorGroup(
					Messages.NavigatorGroupName_MBSRelacion_4001_source, "icons/linkSourceNavigatorGroup.gif", //$NON-NLS-1$
					parentElement);
			Collection<View> connectedViews;
		...
		case MBSHerenciaEditPart.VISUAL_ID: {
			...
			Edge sv = (Edge) view;
			ConcretaNavigatorGroup target = new ConcretaNavigatorGroup(
					Messages.NavigatorGroupName_MBSHerencia_4002_target, "icons/linkTargetNavigatorGroup.gif", //$NON-NLS-1$
					parentElement);
			ConcretaNavigatorGroup source = new ConcretaNavigatorGroup(
					Messages.NavigatorGroupName_MBSHerencia_4002_source, "icons/linkSourceNavigatorGroup.gif", //$NON-NLS-1$
					parentElement);
			Collection<View> connectedViews;
			connectedViews = getLinksTargetByType(Collections.singleton(sv),
					ConcretaVisualIDRegistry.getType(MBSClaseEditPart.VISUAL_ID));
		...
		case MBSContainmentEditPart.VISUAL_ID: {
			...
			Edge sv = (Edge) view;
			ConcretaNavigatorGroup target = new ConcretaNavigatorGroup(
					Messages.NavigatorGroupName_MBSContainment_4003_target, "icons/linkTargetNavigatorGroup.gif", //$NON-NLS-1$
					parentElement);
			ConcretaNavigatorGroup source = new ConcretaNavigatorGroup(
					Messages.NavigatorGroupName_MBSContainment_4003_source, "icons/linkSourceNavigatorGroup.gif", //$NON-NLS-1$
					parentElement);
			Collection<View> connectedViews;
			connectedViews = getLinksTargetByType(Collections.singleton(sv),
					ConcretaVisualIDRegistry.getType(MBSClaseEditPart.VISUAL_ID));
