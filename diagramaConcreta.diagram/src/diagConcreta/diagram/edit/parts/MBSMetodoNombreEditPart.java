 ...
 * @generated
 */
public class MBSMetodoNombreEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public MBSMetodoNombreEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = diagConcreta.diagram.providers.DiagConcretaParserProvider.getParser(
					diagConcreta.diagram.providers.DiagConcretaElementTypes.MBSMetodo_3002, getParserElement(),
