 ...
 * @generated
 */
public class MBSPaqueteNombreEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public MBSPaqueteNombreEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = diagConcreta.diagram.providers.DiagConcretaParserProvider.getParser(
					diagConcreta.diagram.providers.DiagConcretaElementTypes.MBSPaquete_2002, getParserElement(),
