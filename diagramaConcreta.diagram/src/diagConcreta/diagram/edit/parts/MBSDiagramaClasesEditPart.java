 ...
 * @generated
 */
public class MBSDiagramaClasesEditPart extends DiagramEditPart {

	/**
	* @generated
	*/
	public final static String MODEL_ID = "DiagConcreta"; //$NON-NLS-1$
	...
	* @generated
	*/
	public MBSDiagramaClasesEditPart(View view) {
		super(view);
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new diagConcreta.diagram.edit.policies.MBSDiagramaClasesItemSemanticEditPolicy());
		installEditPolicy(EditPolicyRoles.CANONICAL_ROLE,
				new diagConcreta.diagram.edit.policies.MBSDiagramaClasesCanonicalEditPolicy());
			...
			private Command createShortcutsCommand(DropObjectsRequest dropRequest,
				...
				if (command != null) {
					return command.chain(new ICommandProxy(
							new diagConcreta.diagram.edit.commands.DiagConcretaCreateShortcutDecorationsCommand(
