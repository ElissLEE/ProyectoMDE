 ...
 * @generated
 */
public class MBSAtributoNombreEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public MBSAtributoNombreEditPart(View view) {
		super(view);
	}
	...
	*/
	protected Image getLabelIcon() {
		...
		return diagConcreta.diagram.providers.DiagConcretaElementTypes.getImage(parserElement.eClass());
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = diagConcreta.diagram.providers.DiagConcretaParserProvider.getParser(
					diagConcreta.diagram.providers.DiagConcretaElementTypes.MBSAtributo_3001, getParserElement(),
