 ...
 * @generated
 */
public class MBSClaseNombreEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public MBSClaseNombreEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = diagConcreta.diagram.providers.DiagConcretaParserProvider.getParser(
					diagConcreta.diagram.providers.DiagConcretaElementTypes.MBSClase_2001, getParserElement(),
