 ...
 * @generated
 */
public class MBSRelacionLabelNameEditPart extends LabelEditPart implements ITextAwareEditPart {
	...
	*/
	static {
		registerSnapBackPosition(diagConcreta.diagram.part.DiagConcretaVisualIDRegistry
				.getType(diagConcreta.diagram.edit.parts.MBSRelacionLabelNameEditPart.VISUAL_ID), new Point(0, 40));
	}

	/**
	* @generated
	*/
	public MBSRelacionLabelNameEditPart(View view) {
		super(view);
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicy.SELECTION_FEEDBACK_ROLE,
				new diagConcreta.diagram.edit.policies.DiagConcretaTextSelectionEditPolicy());
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = diagConcreta.diagram.providers.DiagConcretaParserProvider.getParser(
					diagConcreta.diagram.providers.DiagConcretaElementTypes.MBSRelacion_4001, getParserElement(),
	...
	protected DirectEditManager getManager() {
		if (manager == null) {
			setManager(new TextDirectEditManager(this, null,
					diagConcreta.diagram.edit.parts.DiagConcretaEditPartFactory.getTextCellEditorLocator(this)));
		}
		return manager;
	}
	...
	*/
	protected IFigure createFigurePrim() {
		return new MBSRelacionLabelFigure();
	}

	/**
	 * @generated
	 */
	public class MBSRelacionLabelFigure extends WrappingLabel {

		/**
		 * @generated
		 */
		public MBSRelacionLabelFigure() {
			this.setText("MBSRelacion");
		}
