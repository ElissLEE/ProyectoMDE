 ...
 * @generated
 */
public class DiagConcretaMarkerNavigationProvider extends AbstractModelMarkerNavigationProvider {

	/**
	* @generated
	*/
	public static final String MARKER_TYPE = diagConcreta.diagram.part.DiagConcretaDiagramEditorPlugin.ID
	...
	*/
	protected void doGotoMarker(IMarker marker) {
		...
		if (targetEditPart != null) {
			diagConcreta.diagram.part.DiagConcretaDiagramEditorUtil.selectElementsInDiagram(editor,
