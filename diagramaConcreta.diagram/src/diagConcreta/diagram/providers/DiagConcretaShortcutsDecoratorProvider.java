 ...
 * @generated
 */
public class DiagConcretaShortcutsDecoratorProvider extends AbstractProvider implements IDecoratorProvider {
	...
	protected class ShortcutsDecorator extends AbstractDecorator {
		...
		*/
		public void refresh() {
			...
			Image image = diagConcreta.diagram.part.DiagConcretaDiagramEditorPlugin.getInstance()
