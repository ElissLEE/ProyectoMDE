 ...
 * @generated
 */
public class DiagConcretaValidationDecoratorProvider extends AbstractProvider implements IDecoratorProvider {
	...
	* @generated
	*/
	private static final String MARKER_TYPE = diagConcreta.diagram.part.DiagConcretaDiagramEditorPlugin.ID
	...
	public void createDecorators(IDecoratorTarget decoratorTarget) {
		...
		if (editPart instanceof GraphicalEditPart || editPart instanceof AbstractConnectionEditPart) {
			...
			if (((DiagramEditDomain) ed)
					.getEditorPart() instanceof diagConcreta.diagram.part.DiagConcretaDiagramEditor) {
	...
	*/
	public boolean provides(IOperation operation) {
		...
		return view != null && diagConcreta.diagram.edit.parts.MBSDiagramaClasesEditPart.MODEL_ID
