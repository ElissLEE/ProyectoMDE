 ...
 * 
 */
package diagConcreta.diagram.parsers;
...
public class MessageFormatParser extends AbstractAttributeParser {
	...
	*/
	public IParserEditStatus isValidEditString(IAdaptable adapter, String editString) {
		...
		if (values == null) {
			return new ParserEditStatus(diagConcreta.diagram.part.DiagConcretaDiagramEditorPlugin.ID,
					IParserEditStatus.UNEDITABLE,
					NLS.bind(diagConcreta.diagram.part.Messages.MessageFormatParser_InvalidInputError,
