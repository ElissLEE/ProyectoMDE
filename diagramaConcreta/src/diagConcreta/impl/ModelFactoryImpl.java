 ...
 * </p>
 * <ul>
 *   <li>{@link diagConcreta.impl.ModelFactoryImpl#getNombre <em>Nombre</em>}</li>
 *   <li>{@link diagConcreta.impl.ModelFactoryImpl#getRuta <em>Ruta</em>}</li>
 *   <li>{@link diagConcreta.impl.ModelFactoryImpl#getListaDiagramas <em>Lista Diagramas</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ModelFactoryImpl extends EObjectImpl implements ModelFactory {
	 ...
	 * @ordered
	 */
	protected EList<MBSDiagramaClases> listaDiagramas;
	...
	protected EClass eStaticClass() {
		return DiagConcretaPackage.Literals.MODEL_FACTORY;
	}
	...
	public void setNombre(String newNombre) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DiagConcretaPackage.MODEL_FACTORY__NOMBRE, oldNombre, nombre));
	}
	...
	public void setRuta(String newRuta) {
		...
		ruta = newRuta;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DiagConcretaPackage.MODEL_FACTORY__RUTA, oldRuta, ruta));
	}
	 ...
	 * @generated
	 */
	public EList<MBSDiagramaClases> getListaDiagramas() {
		if (listaDiagramas == null) {
			listaDiagramas = new EObjectContainmentEList<MBSDiagramaClases>(MBSDiagramaClases.class, this, DiagConcretaPackage.MODEL_FACTORY__LISTA_DIAGRAMAS);
		}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case DiagConcretaPackage.MODEL_FACTORY__LISTA_DIAGRAMAS:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case DiagConcretaPackage.MODEL_FACTORY__NOMBRE:
				return getNombre();
			case DiagConcretaPackage.MODEL_FACTORY__RUTA:
				return getRuta();
			case DiagConcretaPackage.MODEL_FACTORY__LISTA_DIAGRAMAS:
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			...
			case DiagConcretaPackage.MODEL_FACTORY__LISTA_DIAGRAMAS:
				...
				getListaDiagramas().addAll((Collection<? extends MBSDiagramaClases>)newValue);
				return;
		}
