 ...
 * </p>
 * <ul>
 *   <li>{@link diagConcreta.impl.MBSMetodoImpl#getNombre <em>Nombre</em>}</li>
 *   <li>{@link diagConcreta.impl.MBSMetodoImpl#isStatic <em>Static</em>}</li>
 *   <li>{@link diagConcreta.impl.MBSMetodoImpl#getModificadorAcceso <em>Modificador Acceso</em>}</li>
 *   <li>{@link diagConcreta.impl.MBSMetodoImpl#getTipoRetorno <em>Tipo Retorno</em>}</li>
 *   <li>{@link diagConcreta.impl.MBSMetodoImpl#getSemantica <em>Semantica</em>}</li>
 *   <li>{@link diagConcreta.impl.MBSMetodoImpl#getListaParametros <em>Lista Parametros</em>}</li>
 * </ul>
 *
 * @generated
 */
public class MBSMetodoImpl extends EObjectImpl implements MBSMetodo {
	...
	protected EClass eStaticClass() {
		return DiagConcretaPackage.Literals.MBS_METODO;
	}
	...
	public void setNombre(String newNombre) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DiagConcretaPackage.MBS_METODO__NOMBRE, oldNombre, nombre));
	}
	...
	public void setStatic(boolean newStatic) {
		...
		static_ = newStatic;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DiagConcretaPackage.MBS_METODO__STATIC, oldStatic, static_));
	}
	...
	public void setModificadorAcceso(String newModificadorAcceso) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DiagConcretaPackage.MBS_METODO__MODIFICADOR_ACCESO, oldModificadorAcceso, modificadorAcceso));
	}
	...
	public void setTipoRetorno(String newTipoRetorno) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DiagConcretaPackage.MBS_METODO__TIPO_RETORNO, oldTipoRetorno, tipoRetorno));
	}
	...
	public void setSemantica(String newSemantica) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DiagConcretaPackage.MBS_METODO__SEMANTICA, oldSemantica, semantica));
	}
	...
	public EList<MBSParametro> getListaParametros() {
		if (listaParametros == null) {
			listaParametros = new EObjectContainmentEList<MBSParametro>(MBSParametro.class, this, DiagConcretaPackage.MBS_METODO__LISTA_PARAMETROS);
		}
