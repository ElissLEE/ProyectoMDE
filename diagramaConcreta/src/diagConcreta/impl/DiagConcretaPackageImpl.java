 ...
 * @generated
 */
public class DiagConcretaPackageImpl extends EPackageImpl implements DiagConcretaPackage {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 ...
	 * @see diagConcreta.DiagConcretaPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	private DiagConcretaPackageImpl() {
		super(eNS_URI, DiagConcretaFactory.eINSTANCE);
	}
	 ...
	 * 
	 * <p>This method is used to initialize {@link DiagConcretaPackage#eINSTANCE} when that field is accessed.
	 ...
	 * @generated
	 */
	public static DiagConcretaPackage init() {
		if (isInited) return (DiagConcretaPackage)EPackage.Registry.INSTANCE.getEPackage(DiagConcretaPackage.eNS_URI);

		// Obtain or create and register package
		DiagConcretaPackageImpl theDiagConcretaPackage = (DiagConcretaPackageImpl)(EPackage.Registry.INSTANCE.get(eNS_URI) instanceof DiagConcretaPackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI) : new DiagConcretaPackageImpl());

		isInited = true;

		// Create package meta-data objects
		theDiagConcretaPackage.createPackageContents();

		// Initialize created meta-data
		theDiagConcretaPackage.initializePackageContents();

		// Mark meta-data to indicate it can't be changed
		theDiagConcretaPackage.freeze();

  
		// Update the registry and return the package
		EPackage.Registry.INSTANCE.put(DiagConcretaPackage.eNS_URI, theDiagConcretaPackage);
		return theDiagConcretaPackage;
	}
	...
	public EReference getMBSClase_Atributos() {
		return (EReference)mbsClaseEClass.getEStructuralFeatures().get(5);
	}
	 ...
	 * @generated
	 */
	public DiagConcretaFactory getDiagConcretaFactory() {
		return (DiagConcretaFactory)getEFactoryInstance();
	}
