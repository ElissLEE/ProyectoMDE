...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>MBS Containment</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link concreta.impl.MBSContainmentImpl#getSource <em>Source</em>}</li>
 *   <li>{@link concreta.impl.MBSContainmentImpl#getTarget <em>Target</em>}</li>
 *   <li>{@link concreta.impl.MBSContainmentImpl#getNombre <em>Nombre</em>}</li>
 *   <li>{@link concreta.impl.MBSContainmentImpl#getTipo <em>Tipo</em>}</li>
 *   <li>{@link concreta.impl.MBSContainmentImpl#getMultiplicidadA <em>Multiplicidad A</em>}</li>
 *   <li>{@link concreta.impl.MBSContainmentImpl#getMultiplicidadB <em>Multiplicidad B</em>}</li>
 *   <li>{@link concreta.impl.MBSContainmentImpl#getRolA <em>Rol A</em>}</li>
 *   <li>{@link concreta.impl.MBSContainmentImpl#getRolB <em>Rol B</em>}</li>
 *   <li>{@link concreta.impl.MBSContainmentImpl#getNavegabilidadA <em>Navegabilidad A</em>}</li>
 *   <li>{@link concreta.impl.MBSContainmentImpl#getNavegabilidadB <em>Navegabilidad B</em>}</li>
 * </ul>
 *
 * @generated
 */
public class MBSContainmentImpl extends EObjectImpl implements MBSContainment {
	/**
	...
	protected EClass eStaticClass() {
		return ConcretaPackage.Literals.MBS_CONTAINMENT;
	}
		...
		if (source != null && source.eIsProxy()) {
			...
			if (source != oldSource) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, ConcretaPackage.MBS_CONTAINMENT__SOURCE, oldSource, source));
			}
		}
		return source;
	}
	...
	public void setSource(MBSClase newSource) {
		...
		source = newSource;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ConcretaPackage.MBS_CONTAINMENT__SOURCE, oldSource, source));
	}
	...
	public MBSClase getTarget() {
		if (target != null && target.eIsProxy()) {
			...
			if (target != oldTarget) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, ConcretaPackage.MBS_CONTAINMENT__TARGET, oldTarget, target));
			}
		}
		return target;
	}
	...
	public void setTarget(MBSClase newTarget) {
		...
		target = newTarget;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ConcretaPackage.MBS_CONTAINMENT__TARGET, oldTarget, target));
	}
	...
	public void setNombre(String newNombre) {
		...
		nombre = newNombre;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ConcretaPackage.MBS_CONTAINMENT__NOMBRE, oldNombre, nombre));
	}
	...
	public void setTipo(String newTipo) {
		...
		tipo = newTipo;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ConcretaPackage.MBS_CONTAINMENT__TIPO, oldTipo, tipo));
	}
	...
	public void setMultiplicidadA(String newMultiplicidadA) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ConcretaPackage.MBS_CONTAINMENT__MULTIPLICIDAD_A, oldMultiplicidadA, multiplicidadA));
	}
	...
	public void setMultiplicidadB(String newMultiplicidadB) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ConcretaPackage.MBS_CONTAINMENT__MULTIPLICIDAD_B, oldMultiplicidadB, multiplicidadB));
	}
	...
	public void setRolA(String newRolA) {
		...
		rolA = newRolA;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ConcretaPackage.MBS_CONTAINMENT__ROL_A, oldRolA, rolA));
	}
	...
	public void setRolB(String newRolB) {
		...
		rolB = newRolB;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ConcretaPackage.MBS_CONTAINMENT__ROL_B, oldRolB, rolB));
	}
	...
	public void setNavegabilidadA(String newNavegabilidadA) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ConcretaPackage.MBS_CONTAINMENT__NAVEGABILIDAD_A, oldNavegabilidadA, navegabilidadA));
	}
	...
	public void setNavegabilidadB(String newNavegabilidadB) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ConcretaPackage.MBS_CONTAINMENT__NAVEGABILIDAD_B, oldNavegabilidadB, navegabilidadB));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ConcretaPackage.MBS_CONTAINMENT__SOURCE:
				if (resolve) return getSource();
				return basicGetSource();
			case ConcretaPackage.MBS_CONTAINMENT__TARGET:
				if (resolve) return getTarget();
				return basicGetTarget();
			case ConcretaPackage.MBS_CONTAINMENT__NOMBRE:
				return getNombre();
			case ConcretaPackage.MBS_CONTAINMENT__TIPO:
				return getTipo();
			case ConcretaPackage.MBS_CONTAINMENT__MULTIPLICIDAD_A:
				return getMultiplicidadA();
			case ConcretaPackage.MBS_CONTAINMENT__MULTIPLICIDAD_B:
				return getMultiplicidadB();
			case ConcretaPackage.MBS_CONTAINMENT__ROL_A:
				return getRolA();
			case ConcretaPackage.MBS_CONTAINMENT__ROL_B:
				return getRolB();
			case ConcretaPackage.MBS_CONTAINMENT__NAVEGABILIDAD_A:
				return getNavegabilidadA();
			case ConcretaPackage.MBS_CONTAINMENT__NAVEGABILIDAD_B:
