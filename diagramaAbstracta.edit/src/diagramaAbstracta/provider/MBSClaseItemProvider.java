/**
 */
package diagramaAbstracta.provider;
...
/**
 * This is the item provider adapter for a {@link diagramaAbstracta.MBSClase} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class MBSClaseItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 DiagramaAbstractaPackage.Literals.MBS_CLASE__ID_CLASE,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 DiagramaAbstractaPackage.Literals.MBS_CLASE__NOMBRE,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 DiagramaAbstractaPackage.Literals.MBS_CLASE__ESTEREOTIPO,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 DiagramaAbstractaPackage.Literals.MBS_CLASE__MODIFICADOR_ACCESO,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 DiagramaAbstractaPackage.Literals.MBS_CLASE__ABSTRACTA,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 DiagramaAbstractaPackage.Literals.MBS_CLASE__DESCRIPCION,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(DiagramaAbstractaPackage.Literals.MBS_CLASE__ATRIBUTOS);
			childrenFeatures.add(DiagramaAbstractaPackage.Literals.MBS_CLASE__METODOS);
			childrenFeatures.add(DiagramaAbstractaPackage.Literals.MBS_CLASE__LISTA_RELACIONES);
		}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(MBSClase.class)) {
			case DiagramaAbstractaPackage.MBS_CLASE__ID_CLASE:
			case DiagramaAbstractaPackage.MBS_CLASE__NOMBRE:
			case DiagramaAbstractaPackage.MBS_CLASE__ESTEREOTIPO:
			case DiagramaAbstractaPackage.MBS_CLASE__MODIFICADOR_ACCESO:
			case DiagramaAbstractaPackage.MBS_CLASE__ABSTRACTA:
			case DiagramaAbstractaPackage.MBS_CLASE__DESCRIPCION:
				fireNotifyChanged(new ViewerNotification(notification, notification.getNotifier(), false, true));
				return;
			case DiagramaAbstractaPackage.MBS_CLASE__ATRIBUTOS:
			case DiagramaAbstractaPackage.MBS_CLASE__METODOS:
			case DiagramaAbstractaPackage.MBS_CLASE__LISTA_RELACIONES:
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(DiagramaAbstractaPackage.Literals.MBS_CLASE__ATRIBUTOS,
				 DiagramaAbstractaFactory.eINSTANCE.createMBSAtributo()));

		newChildDescriptors.add
			(createChildParameter
				(DiagramaAbstractaPackage.Literals.MBS_CLASE__METODOS,
				 DiagramaAbstractaFactory.eINSTANCE.createMBSMetodo()));

		newChildDescriptors.add
			(createChildParameter
				(DiagramaAbstractaPackage.Literals.MBS_CLASE__LISTA_RELACIONES,
				 DiagramaAbstractaFactory.eINSTANCE.createMBSRelacion()));
	}
	...
	public ResourceLocator getResourceLocator() {
		return DiagramaAbstractaEditPlugin.INSTANCE;
	}
